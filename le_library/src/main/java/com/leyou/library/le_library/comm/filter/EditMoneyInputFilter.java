package com.leyou.library.le_library.comm.filter;
...
/**
 * 用于输入钱并且保留小数点后两位
 * Created by lis on 2018/7/30.
 */
public class EditMoneyInputFilter implements InputFilter {
	/**
	 * 最大数字
	 */
	public double MAX_VALUE = 1000000000;
	...
	public EditMoneyInputFilter() {
		this(0.00);
	}

	public EditMoneyInputFilter(double balance) {
...
//        dend
		...
		if (MAX_VALUE > 0.00 && sumText > MAX_VALUE) {
